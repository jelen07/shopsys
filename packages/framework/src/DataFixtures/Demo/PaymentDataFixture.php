...
class PaymentDataFixture extends AbstractReferenceFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $paymentData->pricesByCurrencyId = [
            $this->getReference(CurrencyDataFixture::CURRENCY_CZK)->getId() => Decimal::fromString('99.95'),
            $this->getReference(CurrencyDataFixture::CURRENCY_EUR)->getId() => Decimal::fromString('2.95'),
        ];
        ...
        $paymentData->pricesByCurrencyId = [
            $this->getReference(CurrencyDataFixture::CURRENCY_CZK)->getId() => Decimal::fromString('49.90'),
            $this->getReference(CurrencyDataFixture::CURRENCY_EUR)->getId() => Decimal::fromString('1.95'),
        ];
        ...
        $paymentData->pricesByCurrencyId = [
            $this->getReference(CurrencyDataFixture::CURRENCY_CZK)->getId() => Decimal::fromString('0'),
            $this->getReference(CurrencyDataFixture::CURRENCY_EUR)->getId() => Decimal::fromString('0'),
        ];
        $paymentData->vat = $this->getReference(VatDataFixture::VAT_HIGH);
