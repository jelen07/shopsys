...
## [shopsys/framework]
### Infrastructure
- in your `docker/php-fpm/Dockerfile` change base image to `php:7.3-fpm-stretch` ([#694](https://github.com/shopsys/shopsys/pull/694))
...
### Tools
- add a new phing target `clean-redis` to your `build.xml` and `build-dev.xml` and use it where you need to clean Redis cache.
  You can find an inspiration in [#736](https://github.com/shopsys/shopsys/pull/736/files)
    ...
    ```
- add a new [script](https://github.com/shopsys/shopsys/pull/759/files#diff-e5f46a7c45e95214037078344ce17721) to `scripts/install.sh`
...
- delete dependency on `oneup/flysystembundle` from your `composer.json`
...
- to allow [support for multiple image sizes #766](https://github.com/shopsys/shopsys/pull/766) you have to
...
- upgrade npm packages to the latest version ([#755](https://github.com/shopsys/shopsys/pull/755))
